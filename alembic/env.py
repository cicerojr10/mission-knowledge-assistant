...
# Isso permite que o Alembic importe módulos como app.models.
...
# Metadata usado pelo Alembic para detectar diferenças
# entre os models SQLModel e o banco de dados.
